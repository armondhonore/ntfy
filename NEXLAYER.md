...
**Live:** [https://relaxed-weasel-ntfy.cloud.nexlayer.ai](https://relaxed-weasel-ntfy.cloud.nexlayer.ai)  
...
**ntfy** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
    - name: ntfy
      image: "registry.nexlayer.io/user_01kece1xyh817dwff7wnarhkxd/ntfy:9f05ab2-fix6"
      path: /
      servicePorts:
        - 80
      vars:
